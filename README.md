...
Semantic HTML reinforces meaning of the information on the webpage on top of defining its look.


2. Name two big differences between ```display: block;``` and ```display: inline;```.
block: starts on a new line and takes up the full width of the webpage.
Inline: shares line with other elements and utilizes the width of its elements.
...
Teams, whether local or remote, can use Git as their version control to track changes. Teams make branches when experimenting or creating new features, all while working collaboratively and ensuring stability before merging to more stable branches or the master repo. 
